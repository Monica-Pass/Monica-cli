...
- Never add a generic URL, custom authorization header, shell command, credential reveal or vault export MCP tool.
...
- Validate repository scope before credential access; re-check grants on each request.
